output "hpc_cache_access_policies_id" {
  ...
  value       = { for k, v in azurerm_hpc_cache_access_policy.hpc_cache_access_policies : k => v.id if v.id != null && length(v.id) > 0 }
}
output "hpc_cache_access_policies_access_rule" {
  ...
  value       = { for k, v in azurerm_hpc_cache_access_policy.hpc_cache_access_policies : k => v.access_rule if v.access_rule != null && length(v.access_rule) > 0 }
}
output "hpc_cache_access_policies_hpc_cache_id" {
  ...
  value       = { for k, v in azurerm_hpc_cache_access_policy.hpc_cache_access_policies : k => v.hpc_cache_id if v.hpc_cache_id != null && length(v.hpc_cache_id) > 0 }
}
output "hpc_cache_access_policies_name" {
  ...
  value       = { for k, v in azurerm_hpc_cache_access_policy.hpc_cache_access_policies : k => v.name if v.name != null && length(v.name) > 0 }
}
